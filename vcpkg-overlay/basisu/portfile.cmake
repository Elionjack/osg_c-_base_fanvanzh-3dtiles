...
# basisu_encoder is static and its upstream CMake target does not propagate the
# Windows OpenCL import library to consumers. Package the bundled import library
# so applications can link the encoder's cl* references.
if(VCPKG_TARGET_IS_WINDOWS)
    if(VCPKG_TARGET_ARCHITECTURE STREQUAL "x64")
        set(OPENCL_IMPORT_LIB "${SOURCE_PATH}/OpenCL/lib/OpenCL64.lib")
    else()
        set(OPENCL_IMPORT_LIB "${SOURCE_PATH}/OpenCL/lib/OpenCL.lib")
    endif()
    file(INSTALL "${OPENCL_IMPORT_LIB}" DESTINATION "${CURRENT_PACKAGES_DIR}/lib")
    file(INSTALL "${OPENCL_IMPORT_LIB}" DESTINATION "${CURRENT_PACKAGES_DIR}/debug/lib")
endif()
